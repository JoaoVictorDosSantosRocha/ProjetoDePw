...
var useIsEqualFirestoreRef = function (value, onChange) {
...
var useIsEqualFirestoreQuery = function (value, onChange) {
...
var useCollectionInternal = function (listen, query, options) {
    ...
    var ref = useIsEqualFirestoreQuery(query, reset);
    useEffect(function () {
        if (!ref.current) {
            setValue(undefined);
            return;
...
var useDocumentInternal = function (listen, docRef, options) {
    var _a = useLoadingValue(), error = _a.error, loading = _a.loading, reset = _a.reset, setError = _a.setError, setValue = _a.setValue, value = _a.value;
    var ref = useIsEqualFirestoreRef(docRef, reset);
    useEffect(function () {
        if (!ref.current) {
            setValue(undefined);
            return;
